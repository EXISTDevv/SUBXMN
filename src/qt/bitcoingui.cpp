...
#endif
    setObjectName("subx");
    //setStyleSheet("#subx { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
   // setStyleSheet("#subx { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #fcfcfc, stop: 1 #ffffff);  }");
    setStyleSheet("#subx { background-color: rgb(192,192,192); background-image: url(:/images/bkg);}");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Senhistory.pngd coins to a SUBX address"));
    ...
    investAction = new QAction(QIcon(":/icons/invest"), tr("&SUBX WEB"), this);
    investAction->setToolTip(tr("SUBX Website"));
    investAction->setCheckable(true);
    investAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(investAction);
    
    discordAction = new QAction(QIcon(":/icons/discord"), tr("&SUBX DISCORD"), this);
    discordAction->setToolTip(tr("SUBX Discord"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&SUBX Website"), this);
	pioAction->setToolTip(tr("Visit the Official SUBX website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk SUBX discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&SUBX Slack"), this);
	chainAction->setToolTip(tr("Join SUBX Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&SUBX Explorer"), this);
	explorerAction->setToolTip(tr("SUBX Explorer"));
    aboutAction = new QAction(tr("&About SUBX"), this);
...
void BitcoinGUI::gotoinvestPage()
{
  ...
  QDesktopServices::openUrl(QUrl("http://www.subexcoin.com"));
  exportAction->setEnabled(false);
  disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}
...
void BitcoinGUI::gotodiscordPage()
{
  ...
  QDesktopServices::openUrl(QUrl("https://discord.gg/73PwrnK"));
  exportAction->setEnabled(false);
  disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}
...
{
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=5038669.0"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("http://subexcoin.com"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("http://144.202.18.54:3001/"));
}
