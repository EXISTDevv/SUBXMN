...
private slots:
    ...
    QString BuySUBX(QString OrderType, double Quantity, double Rate);
    QString SellSUBX(QString OrderType, double Quantity, double Rate);
